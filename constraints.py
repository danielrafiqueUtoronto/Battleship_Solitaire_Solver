...
class NumShipConstraint(Constraint):
    #for 1/0 variables count the number of ajacent variables = 1 and consider it as one ship. then make sure this is equal to number of ships
    
    ''' check that number of ships created match ship constraint '''
    def __init__(self, name, scope):
        Constraint.__init__(self, name, scope)
        self._name = "NShips_" + name
